<?php
  if(!empty($_GET['id']) && !empty($_GET['cardHolder']) && !empty($_GET['idRequest'])) {
    $GET = filter_var_array($_GET, FILTER_SANITIZE_STRING);

    $id = $GET['id'];
    $cardHolder = $GET['cardHolder'];
    $idRequest = $GET['idRequest'];
    echo "idrequest :";
    echo $idRequest;

  } else {
    header('Location: paymentService.php');
  }
?>
...
<body>
  <div class="container mt-4">
    ...
    <p><a href="" class="btn btn-light mt-2" style="font-size:22px;">Voir la facture</a></p>
