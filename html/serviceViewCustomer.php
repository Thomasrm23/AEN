...
// Recuperation des donnees pour le client
$serviceManager = new ServiceManager($manager);
$services = $serviceManager->getServiceCustomer($idCustomer);
$row = $services[0];
?>
...
<body>
  ...
  <form name="frmServiceViewCustomer" method="post" action="">
    ...
    <section class="contact-page-area section-gap">
        ...
        <div class="row justify-content-center">
          <td>
            <button type="submit" name="buttonBill" id="buttonBill" onclick="setViewBill()">Voir la facture</button>
